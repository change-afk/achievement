		...
		<ul class="layui-nav layui-nav-tree">
			...
			<li class="layui-nav-item">
				...
				<dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;" data-url="bar/password.jsp">
			...
			<li class="layui-nav-item">
				<a href="javascript:;">
				   ...
				   <em class="layui-nav-more"></em>
				    ...
				    <dl class="layui-nav-child">
				    	<dd>
				    		<a href="javascript:;" data-url="bar/teacher.jsp">
				    		   <i class="iconfont icon-yonghu1" data-icon='icon-yonghu1'></i>
				    		   <span>教师信息</span>
				    		</a>
				    	</dd>
				    	<dd>
				    		<a href="javascript:;" data-url="bar/teacherImport.jsp">
				...
				<a href="javascript:;">
				   ...
				   <em class="layui-nav-more"></em>
				    ...
				    <dl class="layui-nav-child">
				    	...
				    	<!-- <dd>
				    		<a href="javascript:;" data-url="bar/studentImport.jsp">
				    		   <i class="iconfont icon-zhuti" data-icon='icon-zhuti'></i>
				    		   <span>批量导入</span>
				    		</a>
				    	</dd> -->
			...
			<li class="layui-nav-item">
				...
				<dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;" data-url="bar/resume.jsp">
                            <i class="iconfont icon-quanxian2" data-icon='icon-quanxian2'></i>
                            <span>履历管理</span>
                        </a>
                    </dd>
			...
			<li class="layui-nav-item">
				...
				<dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;" data-url="bar/news.jsp">
