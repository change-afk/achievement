...
<body class="childrenBody">
	<form class="layui-form">
		<div class="layui-form-item">
			<label class="layui-form-label">研究方向概述</label>
			<div class="layui-input-block"> 
				<textarea class="layui-textarea" id="rdesc" lay-verify="content" style="width:70%;height:160px"></textarea>
			</div>
		</div>
		<br><br><br><br>
		<div class="layui-form-item">
...
layui.use(['form','layer','laydate','jquery'],function(){ 
	...
	form.on("submit(savePass)",function(data){
		...
		var url = "../../research/addResearch";
	 	 $.ajax({
			url:url,
			type:"post", 
			dataType:"json",
			async:false,
		    data:{"tid":tid,"rdesc":rdesc}, 
