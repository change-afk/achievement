		...
		<div class="layui-form-item">
			<div class="layui-inline">		
				...
				<div class="layui-input-inline">
					<input class="layui-input newsAuthor" lay-verify="required" id="tid" placeholder="请输入工号" type="text">
				</div>
			</div>
			<div class="layui-inline">		
				<label class="layui-form-label">姓名</label>
				<div class="layui-input-inline">
					<input class="layui-input newsAuthor" lay-verify="required" id="tname" placeholder="请输入姓名" type="text">
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label">性别</label>
				<div class="layui-input-inline">
					<select name="browseLook"  id="tsex" lay-filter="browseLook">
...
layui.use(['form','layer','jquery','laydate','upload'],function(){
	...
	laydate.render({
 	...
 	form.on("submit(addTeacher)",function(){
 		...
 		jsonStr += '"tsex":"'+$("#tsex option:selected").text()+'",'; 
 		...
 		$.ajax({
	        ...
	        success:function(data){
	        	if(data.flag=="1"){
	        		...
	        		top.layer.close(index);
	        		top.layer.msg("添加失败，后端接口异常！"+data.msg, {icon: 2});
	        	}
	        },
	        error:function(){ 
	        	top.layer.close(index);
