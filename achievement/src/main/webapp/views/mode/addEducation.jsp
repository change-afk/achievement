		...
		<div class="layui-form-item">
			<div class="layui-inline">
		      ...
		      <div class="layui-input-inline">
		        <input type="text" class="layui-input" id="etime" lay-verify="required" placeholder=" - ">
		      </div>
		    </div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block"> 
				<textarea class="layui-textarea" id="edesc" lay-verify="content" style="width:70%;height:160px"></textarea>
			</div>
		</div>
		<br><br><br><br>
		<div class="layui-form-item">
...
layui.use(['form','layer','laydate','jquery'],function(){ 
	...
	form.on("submit(savePass)",function(data){
		...
		var url = "../../education/addEducation";
	 	 $.ajax({
			url:url,
			type:"post", 
			dataType:"json",
			async:false,
		    data:{"tid":tid,"etime":etime,"edesc":edesc}, 
