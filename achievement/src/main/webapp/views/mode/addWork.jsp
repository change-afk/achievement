		...
		<div class="layui-form-item">
			<div class="layui-inline">
		      ...
		      <div class="layui-input-inline">
		        <input type="text" class="layui-input" id="wtime" lay-verify="required" placeholder=" - ">
		      </div>
		    </div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block"> 
				<textarea class="layui-textarea" id="wdesc" lay-verify="content" style="width:70%;height:160px"></textarea>
			</div>
		</div>
		<br><br><br><br>
		<div class="layui-form-item">
	...
	form.on("submit(savePass)",function(data){
		...
		var url = "../../work/addWork";
	 	 $.ajax({
			...
			dataType:"json",
			async:false,
		    data:{"tid":tid,"wtime":wtime,"wdesc":wdesc}, 
